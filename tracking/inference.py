    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for p in self.legalPositions:
            ...
            for key, pro in newPosDist.items():
                allPossible[key] += self.beliefs[p] * pro
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance == None:
            ...
            for p in self.particles:
                dis = util.manhattanDistance(p, pacmanPosition)
                allPossible[p] += emissionModel[dis]
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            for i in range(len(newParticle)):
                setGameState = setGhostPositions(gameState, oldParticle)
                dist = getPositionDistributionForGhost(setGameState,i,self.ghostAgents[i])
